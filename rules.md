...
| 招商银行数字人民币消费 | 通知 | notice/cmb.pb/招商银行数字人民币消费.js |
...
| 规则名称 | 规则类型 | 规则路径 |
|---------|----------|----------|
| 东莞银行收入通知 | 通知 | notice/cn.dongguanbank.mbank.prd/东莞银行收入通知.js |
...
| 短信广发银行 | 数据 | app/com.android.phone/短信广发银行.js |
| 短信广西农信 | 数据 | app/com.android.phone/短信广西农信.js |
| 短信建设银行 | 数据 | app/com.android.phone/短信建设银行.js |
| 短信微众银行 | 数据 | app/com.android.phone/短信微众银行.js |
| 短信抖音月付消费通知 | 数据 | app/com.android.phone/短信抖音月付消费通知.js |
...
| 短信湖南农信 | 数据 | app/com.android.phone/短信湖南农信.js |
| 短信潍坊银行 | 数据 | app/com.android.phone/短信潍坊银行.js |
| 短信网商银行 | 数据 | app/com.android.phone/短信网商银行.js |
| 短信贵州银行 | 数据 | app/com.android.phone/短信贵州银行.js |
| 短信邮储银行 | 数据 | app/com.android.phone/短信邮储银行.js |
...
| 规则名称 | 规则类型 | 规则路径 |
|---------|----------|----------|
| 中国银行转账OCR | 数据 | ocr/com.chinamworld.bocmbci/中国银行转账OCR.js |

## com.chinamworld.main

| 规则名称 | 规则类型 | 规则路径 |
|---------|----------|----------|
| 银行动账提醒 | 通知 | notice/com.chinamworld.main/银行动账提醒.js |

## com.cib.xyk

| 规则名称 | 规则类型 | 规则路径 |
|---------|----------|----------|
| 兴业银行信用卡消费通知 | 通知 | notice/com.cib.xyk/兴业银行信用卡消费通知.js |
...
| 规则名称 | 规则类型 | 规则路径 |
|---------|----------|----------|
| 掌上生活消费通知 | 通知 | notice/com.cmbchina.ccd.pluto.cmbActivity/掌上生活消费通知.js |
| 掌上生活退款 | 通知 | notice/com.cmbchina.ccd.pluto.cmbActivity/掌上生活退款.js |
| 掌上生活交易明细 | 数据 | ocr/com.cmbchina.ccd.pluto.cmbActivity/掌上生活交易明细.js |

## com.ecitic.bank.mobile

| 规则名称 | 规则类型 | 规则路径 |
|---------|----------|----------|
| 中信银行收入 | 通知 | notice/com.ecitic.bank.mobile/中信银行收入.js |
...
| 支付宝余额宝转入 | 数据 | app/com.eg.android.AlipayGphone/支付宝余额宝转入.js |
| 支付宝余额宝银行卡定投 | 数据 | app/com.eg.android.AlipayGphone/支付宝余额宝银行卡定投.js |
| 支付宝信用卡交易 | 数据 | app/com.eg.android.AlipayGphone/支付宝信用卡交易.js |
| 支付宝商家收款 | 数据 | app/com.eg.android.AlipayGphone/支付宝商家收款.js |
| 支付宝商家转账 | 数据 | app/com.eg.android.AlipayGphone/支付宝商家转账.js |
| 支付宝基金 | 数据 | app/com.eg.android.AlipayGphone/支付宝基金.js |
| 支付宝小猪存钱罐 | 数据 | app/com.eg.android.AlipayGphone/支付宝小猪存钱罐.js |
| 支付宝小荷包 | 数据 | app/com.eg.android.AlipayGphone/支付宝小荷包.js |
| 支付宝悄悄攒自动攒入 | 数据 | app/com.eg.android.AlipayGphone/支付宝悄悄攒自动攒入.js |
| 支付宝收入 | 数据 | app/com.eg.android.AlipayGphone/支付宝收入.js |
| 支付宝易校园消费通知 | 数据 | app/com.eg.android.AlipayGphone/支付宝易校园消费通知.js |
| 支付宝消费 | 数据 | app/com.eg.android.AlipayGphone/支付宝消费.js |
| 支付宝淘宝订单 | 数据 | app/com.eg.android.AlipayGphone/支付宝淘宝订单.js |
| 支付宝生活缴费小程序 | 数据 | app/com.eg.android.AlipayGphone/支付宝生活缴费小程序.js |
| 支付宝碰一下领红包 | 数据 | app/com.eg.android.AlipayGphone/支付宝碰一下领红包.js |
| 支付宝笔笔攒 | 数据 | app/com.eg.android.AlipayGphone/支付宝笔笔攒.js |
| 支付宝红包 | 数据 | app/com.eg.android.AlipayGphone/支付宝红包.js |
| 支付宝网商银行 | 数据 | app/com.eg.android.AlipayGphone/支付宝网商银行.js |
| 支付宝花呗主动还款 | 数据 | app/com.eg.android.AlipayGphone/支付宝花呗主动还款.js |
| 支付宝花呗自动还款 | 数据 | app/com.eg.android.AlipayGphone/支付宝花呗自动还款.js |
| 支付宝花呗退款 | 数据 | app/com.eg.android.AlipayGphone/支付宝花呗退款.js |
| 支付宝蚂蚁星愿 | 数据 | app/com.eg.android.AlipayGphone/支付宝蚂蚁星愿.js |
| 支付宝蚂蚁森林 | 数据 | app/com.eg.android.AlipayGphone/支付宝蚂蚁森林.js |
| 支付宝蚂蚁财富 | 数据 | app/com.eg.android.AlipayGphone/支付宝蚂蚁财富.js |
| 支付宝账单列表 | 数据 | app/com.eg.android.AlipayGphone/支付宝账单列表.js |
| 支付宝转账 | 数据 | app/com.eg.android.AlipayGphone/支付宝转账.js |
| 支付宝转账到银行卡 | 数据 | app/com.eg.android.AlipayGphone/支付宝转账到银行卡.js |
| 支付宝转账收款到余额宝 | 数据 | app/com.eg.android.AlipayGphone/支付宝转账收款到余额宝.js |
| 支付宝还款通知 | 数据 | app/com.eg.android.AlipayGphone/支付宝还款通知.js |
| 支付宝小荷包自动攒 | 通知 | notice/com.eg.android.AlipayGphone/支付宝小荷包自动攒.js |
| 支付宝小荷包资金变动 | 通知 | notice/com.eg.android.AlipayGphone/支付宝小荷包资金变动.js |
| 支付宝支付 | 通知 | notice/com.eg.android.AlipayGphone/支付宝支付.js |
...
| 规则名称 | 规则类型 | 规则路径 |
|---------|----------|----------|
| 钱包支付 | 通知 | notice/com.finshell.wallet/钱包支付.js |
...
| 规则名称 | 规则类型 | 规则路径 |
|---------|----------|----------|
| 小米智能卡消费通知 | 通知 | notice/com.miui.tsmclient/小米智能卡消费通知.js |
| 微信公众号河南农信 | 数据 | app/com.tencent.mm/微信公众号河南农信.js |
| 微信公众号河南农商银行 | 数据 | app/com.tencent.mm/微信公众号河南农商银行.js |
| 微信公众号泉州农村商业银行 | 数据 | app/com.tencent.mm/微信公众号泉州农村商业银行.js |
| 微信公众号浙商银行 | 数据 | app/com.tencent.mm/微信公众号浙商银行.js |
| 微信公众号浦发银行 | 数据 | app/com.tencent.mm/微信公众号浦发银行.js |
| 微信公众号浦发银行信用卡 | 数据 | app/com.tencent.mm/微信公众号浦发银行信用卡.js |
| 微信公众号潍坊银行 | 数据 | app/com.tencent.mm/微信公众号潍坊银行.js |
| 微信公众号珠海华润银行 | 数据 | app/com.tencent.mm/微信公众号珠海华润银行.js |
| 微信公众号盛京银行信用卡 | 数据 | app/com.tencent.mm/微信公众号盛京银行信用卡.js |
| 微信公众号网商银行 | 数据 | app/com.tencent.mm/微信公众号网商银行.js |
...
| 微信公众号饿了么本地生活 | 数据 | app/com.tencent.mm/微信公众号饿了么本地生活.js |
| 微信公众号黑龙江省农村信用社 | 数据 | app/com.tencent.mm/微信公众号黑龙江省农村信用社.js |
| 微信公众号齐鲁银行 | 数据 | app/com.tencent.mm/微信公众号齐鲁银行.js |
| 微信发红包 | 数据 | app/com.tencent.mm/微信发红包.js |
...
| 微信支付转账（红包）退款 | 数据 | app/com.tencent.mm/微信支付转账（红包）退款.js |
| 微信支付零钱提现到账 | 数据 | app/com.tencent.mm/微信支付零钱提现到账.js |
| 微信支付零钱通定时转入 | 数据 | app/com.tencent.mm/微信支付零钱通定时转入.js |
| 微信支付零钱通收益 | 数据 | app/com.tencent.mm/微信支付零钱通收益.js |
| 微信支付零钱通转出 | 数据 | app/com.tencent.mm/微信支付零钱通转出.js |
| 微信收红包 | 数据 | app/com.tencent.mm/微信收红包.js |
| 微信群收款 | 数据 | app/com.tencent.mm/微信群收款.js |
| 微信账单 | 数据 | app/com.tencent.mm/微信账单.js |
...
| 云闪付退款通知 | 通知 | notice/com.unionpay/云闪付退款通知.js |
| 云闪付预授权完成通知 | 通知 | notice/com.unionpay/云闪付预授权完成通知.js |
| 云闪付交易详情 | 数据 | ocr/com.unionpay/云闪付交易详情.js |
...
| 规则名称 | 规则类型 | 规则路径 |
|---------|----------|----------|
| 广西北部湾银行转入 | 通知 | notice/com.yitong.bbw.mbank.android/广西北部湾银行转入.js |

## com.yitong.mbank.pzh_ps

| 规则名称 | 规则类型 | 规则路径 |
|---------|----------|----------|
| 泸州银行支出通知 | 通知 | notice/com.yitong.mbank.pzh_ps/泸州银行支出通知.js |

## de.number26.android

| 规则名称 | 规则类型 | 规则路径 |
|---------|----------|----------|
| N26银行支付通知 | 通知 | notice/de.number26.android/N26银行支付通知.js |
